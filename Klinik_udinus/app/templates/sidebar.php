...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="http://localhost/Klinik_udinus/index.php" img src="assets/images/logo/logoudinus.png">
          <div class="brand-logo"></div>
          <h2 class="brand-text mb-0">Klinik Udinus</h2>
        </a></li>
